function [out1,out2,out3] = ginput(arg1,ptr)
...
%   It also uses the pointer PTR instead of the default, full crosshair.
%
%   [X,Y] = GINPUT gathers an unlimited number of points until the
%   return key is pressed.
% 
%   [X,Y,BUTTON] = GINPUT(N,PTR) returns a third result, BUTTON, that 
